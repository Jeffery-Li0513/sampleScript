...
def image_compose(image_colnum, image_size, image_rownum, image_names, image_save_path, x_new, y_new):
    to_image = Image.new('RGB', (image_colnum * x_new, image_rownum * y_new), color=(255,255,255))  # 创建一个新图
...
def merge_images(image_dir_path, image_size, image_colnum):
    ...
    image_save_path = r'{}.gif'.format(image_dir_path)  # 图片转换后的地址
...
if __name__ == '__main__':
    image_dir_path = r'D:\gitRepo\SmapleScripts\图片\图'  # 图片集地址
